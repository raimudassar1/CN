...
window.ScenarioModule = (() => {
  ...
  // ── Module View: Scenarios + Module Vocabulary ────────────────
  ...
  function renderModuleView(container, module) {
    ...
    container.innerHTML = `
      ...
      <div class="module-layout mt-24">
        ...
        <div class="module-vocab-section">
          <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px">
            <h3 class="section-title" style="margin-bottom:0">Module Vocabulary</h3>
            <div class="search-box search-box-sm">
                <input type="text" id="module-vocab-search" placeholder="Search..." oninput="ScenarioModule.handleVocabSearch(this.value)">
            </div>
          </div>
  ...
  function renderVocabGrid(vocab = []) {
    ...
    return filtered.map(v => `
      <div class="ch-vocab-card ch-vocab-card-sm" onclick="ScenarioModule.showVocabDetail('${v.word.replace(/'/g, "\\'")}')">
